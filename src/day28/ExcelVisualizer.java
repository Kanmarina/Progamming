...
public class ExcelVisualizer {
   ...
   Cell(6,1)= 67	Cell(6,2)= 33	Cell(6,3)= 98	Cell(6,4)= 34
        ...
        //how to print 100 and 90 from this array
        ...
        System.out.println(Arrays.toString(sheet1[0]));//seeing what's inside first 1d array
        System.out.println(sheet1[0].length);//getting the length of first 1d array

        for (int x = 0; x <sheet1.length ; x++) {
            System.out.println(sheet1[x].length);
        }
