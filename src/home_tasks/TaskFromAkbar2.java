...
//}else {
//    String name2=name.substring(0,1) +name.substring(0,1);
...
/*String fullName = "Marina Kan";

int firstSpaceIndex = fullName.indexOf(" ");
String firstWord = fullName.substring(0,1);
int secondWordBeginningIndex = fullName.indexOf(" ")  ;
String secondWord = fullName.(firstSpaceIndex, secondWordBeginningIndex)  ;
String  initial=firstWord+secondWord;
