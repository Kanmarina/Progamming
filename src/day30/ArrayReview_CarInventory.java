...
public class ArrayReview_CarInventory {
  ...
  and how many civic you have*/
        ...
        //we can use contains. startWith. endWith
        int chevCount = 0;
        int civicCount = 0;
       /* for(String  eachCar : cars){
        ...
        System.out.println("chevrolet count = " + chevCount);
        System.out.println("civic count = " + civicCount);
...
//                            " Car Model is " + eachCarSplitted[1]   );
      ...
      //find all the car with model has only 2 chars
        int count2 =0;
        for (String eachCar : cars) {
            String[] eachCarSpl = eachCar.split("-");
            if(eachCarSpl[1].length() ==2) {
