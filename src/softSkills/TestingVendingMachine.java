...
Performance testing:
  ...
  - perform consecutive transactions, to verify behaviour
...
Visibility testing:
  ...
  - welcome text to display
    ...
    /*
    Positive Test Input money, select product, machine dispenses product,
     balance deducted from the machine

    Negative test Do not input money, select product,
    machine notifies the buyer for insufficient balance
     */
}
