...
public class MovieUtility {
    ...
    public static void main(String[] args) {
        ...
        printShorterDurationMovieName(m2,m3);
    ...
    public static void printMovieInformation(Movie movieObj) {
        //TODO YOUR CODE HERE
        System.out.println(movieObj.getName()+" is "+ movieObj.getLength()
                +" hour long and it's genre is "+movieObj.getGenre());
    }
    /**
     * A void method that accept any movie object
    ...
    public static void printMovieNameCharacters(Movie movieObj) {
        //TODO YOUR CODE HERE
  //      for (int i = 0; i <movieObj.getLength(); i++) {
    //        if (movieObj.getName().equalsIgnoreCase("Joker");
     //getString then uppercase
        //add the dash between chars
...
//concatenate add dash between and return
        //getname
