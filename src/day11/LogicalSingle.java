...
public class LogicalSingle {
    public static void main(String[] args) {

        //&& 2amprersand & 1ampersanf >>> Logical AND operator
        // This is used to check both conditions are true at th

        // && is called short circiut AND
        // >> it doesn not check the next condition
        // as long as the first condition is false
